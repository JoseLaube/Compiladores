...
happyExpList = Happy_Data_Array.listArray (0,114) ([17408,1920,1088,112,6,32768,2,0,0,1088,112,68,7,0,0,0,0,0,0,0,1536,0,0,61792,1,32836,16391,30724,0,0,61792,1,24704,24576,505,17408,1792,1088,112,68,16391,28676,17408,1792,1088,112,68,16391,28676,17408,1920,1088,120,134,0,0,17408,1792,1088,112,0,0,0,0,0,0,0,0,24576,0,1536,0,96,0,6,24576,0,1536,0,640,0,40,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_calc","Inico","ExprL","ExprR","Expr","Term","Factor","'+'","'-'","'*'","'/='","'/'","'('","')'","'<='","'>='","'>'","'<'","'=='","'&&'","'||'","'!'","Numi","Num","Id","%eof"]
...
action_13 (21) = happyShift action_27
...
action_14 (6) = happyGoto action_12
action_14 (7) = happyGoto action_19
action_14 (8) = happyGoto action_3
action_14 (9) = happyGoto action_4
...
action_15 (6) = happyGoto action_12
action_15 (7) = happyGoto action_17
action_15 (8) = happyGoto action_3
...
action_19 (16) = happyShift action_36
...
action_21 (8) = happyGoto action_45
...
action_22 (7) = happyGoto action_44
...
action_27 (8) = happyGoto action_3
...
action_28 (6) = happyGoto action_12
...
action_29 (6) = happyGoto action_12
action_29 (7) = happyGoto action_17
action_29 (8) = happyGoto action_3
action_29 (9) = happyGoto action_4
...
action_45 (14) = happyShift action_33
action_45 _ = happyReduce_15

action_46 (12) = happyShift action_32
action_46 (14) = happyShift action_33
...
happyReduction_20 (HappyTerminal (NUMI happy_var_1))
	 =  HappyAbsSyn9
		 (Cint happy_var_1
	)
...
happyNewToken action sts stk (tk:tks) =
	...
	OR -> cont 23;
	NOT -> cont 24;
	NUMI happy_dollar_dollar -> cont 25;
	NUM happy_dollar_dollar -> cont 26;
	ID happy_dollar_dollar -> cont 27;
	_ -> happyError' ((tk:tks), [])
	}
